...
export default {
  ...
  methods: {
    ...
    async fetchUsers() {
      try {
        const response = await axios.get('https://front-iqbz.onrender.com/api/users'); // Requisição GET para buscar usuários
    ...
    async blockUser(user) {
      try {
        const response = await axios.patch(`https://front-iqbz.onrender.com/admin/api/users/${user._id}`, {
